...
void usage(char exe[]){
  printf("%s: <.h5-file> <output_file> <loop (Scalar, dOp, Loops, LoopsCv, LpsDw, LpsDwCv)> <momx> <momy> <momz> <conf_traj> <Nstoch> <T>\n",exe);
  exit(-1);
}
...
int main(int argc, char *argv[]){
  ...
  char *h5_file, *out_file, *loop,*mom[3],*conf,*Ns;
